...
#  Aynan sizning tayyor Word (.docx) shabloningizni to'ldiradi
#  Barcha logotip, pechat, imzo, qalin (bold) va qiya (italic)
#  formatlar 100% siznikidek saqlanadi!
# ============================================================
...
async def _generate_and_send(chat_id: int, tpl: dict, answers: dict):
    ...
    wait_resp = await _send_and_get_id(chat_id, "⏳ Sizning shabloningiz to'ldirilmoqda...")

    try:
        # Aynan sizning asl Word faylingiz to'ldiriladi (barcha logotip, pechat, imzo, bold va italic shriftlar 100% siznikidek saqlanadi)
        ...
        await send_document(
            ...
            caption=(
                f"✅ <b>{custom_doc_name}</b> muvaffaqiyatli tahrirlandi va tayyorlandi!\n\n"
                f"📄 Siz yaratgan rasmiy shablon bo'yicha tayyorlandi.\n"
